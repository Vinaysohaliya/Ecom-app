...
const MyCarousel = () => {
  return (
    ...
    >
      <div>
        <Image width={400}
          height={300} src="https://encrypted-tbn0.gstatic.com/shopping?q=tbn:ANd9GcQ5T6z0HKJtqaE1o1FXRZh3cyY0P2gN1qtLShQqtWmiXyezI8SVrfB05Zs5a9oMOi58WABFhjEmonuenKLkM7sSosPfXfl995kT0bAQYo8T8CVhIDjxXxho&usqp=CAc" alt="Product 1" />
