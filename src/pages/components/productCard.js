...
const ProductCard = ({ product }) => {
  return (
    <div className="product-card w-56 mx-2">
      <img src='https://preview.colorlib.com/theme/capitalshop/assets/img/gallery/latest4.jpg' alt={product.name} className='h-72' />
      ...
      <div className='flex items-center justify-evenly mt-2'>
        ...
        <button className="bg-black hover:bg-red-700 text-white px-4 py-2 mt-2 ">
